CREATE DATABASE SamochodyKierowcy;
GO
USE SamochodyKierowcy;
GO
...
INSERT INTO samochody(marka, model,zasilanie, rocznik, kolor, spalanie, cena) VALUES
					 ...
					 ('Ford','Mondeo',  'benzyna',1998,'rÛøowy',5, 3500),
					 ...
					 ('Fiat','Punto', 'diesel', 2005,'b≥Íkitny',7.5, 8500),
					 ...
					 ('Fiat','126p', 'benzyna', 2015, 'brπzowy',11,75000),
					...
					('Opel', 'Tigra', 'benzyna', 1998, 'srebrny', 5.8, 2999),
					 ...
					 ('Dodge','Punto','diesel',2004,'zÛ≥ty',7.5,5600),
					...
					('Mitsubishi','Gallardo','BENZYNA',1990,'Zolty',25,185000),
					 ...
					 ('Nissan','Micra', 'benzyna', 2017, 'brπzowy',11,8500),
...
INSERT INTO kierowca(imie, nazwisko,kod, miasto, ulica) VALUES
					('Jennifer', 'Piechol', '98-220', 'ZduÒska Wola', 'G≥Ûwna 36' ),
					('Alice', 'Sadowski','98-160', 'SÍdziejowice', 'èrÛdlana 6'),
					('Kim', 'DÛ≥kowski','98-220', 'ZduÒska Wola', 'G≥Ûwna 6'),
					('Kuba', 'Urbaniak','98-100', '£ask', 'Boczna 12'),
					('Kola', 'Mianowski','98-100', '£ask', 'Wojskowa 15'),
					('Sasza', 'WiÍch','98-240', 'Szadek', '£aska 20'),
					('Liz', 'Olejnik','98-220', 'ZduÒska Wola', 'ZduÒska 7'),
					('Mateusz', 'Dobrzycki','98-240', 'Szadek', 'Tuwima 18'),
					('Alan', 'Pompel', '98-240', 'Szadek', 'S≥owckiego 29'),
					('Dawid', 'Dariuszowski', '98-240', 'Szadek', 'ZagÛrna 2'),
					...
					('Karolina','£πczek','98-100','£ask','Polna'),
					('Agnieszka','Wilk','98-220','ZduÒska Wola','Kacza'),
					('Barbara','Tkaczyk','98-100','£ask','Sieradzka'),
					('Patrycja','Felakowska','98-220','Bilew','Skalna'),
					('Izabela','B≥aszczyk','98-100','Wydrzyn','G≥Ûwna'),
					...
					('Janusz', 'Pawlacz', '12-112', 'KrakÛw', 'Blokowa 34/2'),
					...
					('Artur', 'Pawlacz', '12-112', 'KrakÛw', 'Blokowa 34/2'),
					('Adam', 'Policjant', '00-997', 'Warszawa', 'Policyjna 112/997'),
					('Daria', 'Sadowska', '98-100', '£ask', 'Jana Paw≥a 2/29'),
					 ('Andrzej','Kowalski','33-333','£Ûdü','Jab≥eczna'),
					 ('Mateusz','Olejnik','77-777','Warszawa','Mickiewicza'),
					 ('Robert','Mianowski','48-999','KrakÛw','Wa≥Ísy'),
					 ('Adam','DobrzyÒski','48-998','Radom','Juliusza'),
					 ('Alan','Piechol','48-997','Zabrze','Jasna'),
					 ('Jan','Rumun','11-122','Wroc≥aw','Kossaka'),
					 ('Pawe≥','Kowalski','22-222','K≥odzko','£Ûdzka'),
					 ('Janusz','Paw≥owski','44-444','Czarnystok','Sieradzka'),
					 ('Pawlacz','Pawelski','66-666','£oúla-GÛra','£aska'),
					 ('Katarzyna','Kulesza','98-220','ZduÒska-Wola','Sieradzka'),
					('Izabela','Bronka','98-200','Sieradz','Polna'),
					('Magdalena','Grπdzka','98-100','£ask','£aska'),
					('Angelika','Witkowska','98-200','Sieradz','Kwiatowa'),
					('Aleksandra','Szewczyk','98-100','£ask','Lesna'),
					('Mateusz','Dobrzycki','98-220','ZduÒska Wola', 'Korczew'),
					('Pawe≥','Mik≥a','98-170','Widawa', 'åwierczÛw'),
					('Robert','Olejnik','98-220','ZduÒska Wola', 'Wojs≥awice'),
					('Alan','Piechol','98-250','PruszkÛw', 'GÛrna'),
					('Dawid','Sadowski','98-190','Piaski', 'Pisakowa'),
					('Czes≥aw', 'GÛrski', '55-210', 'Sopot', 'Polna'),
					('Wies≥aw', 'Dolny', '60-250', 'Warszawa', 'Ciemna'),
					('Ola', 'Jagie≥a', '98-220', 'ZduÒska Wola', 'Polna'),
					('Adam', 'Bronka','98-160', 'Sieradz', 'Ludzka'),
					('Patrycja', 'Szewczyk','98-220', 'ZduÒska Wola', 'Polna'),
					('Wojtek', 'Hajdukiewicz','98-100', '£ask', 'Piwna'),
					('Sylwia', 'Szewczyk','98-100', '£ask', 'Leúna'),
					('Dominik', 'WiÍch','98-240', 'Szadek', 'ZduÒska'),
					('Kasia', 'Perlik','98-220', 'ZduÒska Wola', '£aska'),
					...
					('Artur', 'Nowak', '12-112', 'KrakÛw', 'Blokowa 34/2'),
...
update samochody set kolor='øÛ≥ty' where kolor='zÛ≥ty';
update samochody set kolor='øÛ≥ty' where kolor='zolty';
update samochody set marka='BMW' where marka='BWM';
update samochody set marka='Mercedes' where marka='Merdcedes';
update samochody set marka='Fiat' where marka='Dodge';
update samochody set marka='Dodge' where marka='Mustang';
update samochody set marka='Lamborghini' where marka='Mitsubishi';
update kierowca set id_s=id_k where id_k <=50

SELECT COUNT(marka) AS 'Liczba_samochodÛw' FROM samochody;
SELECT COUNT(nazwisko) AS 'Liczba_kierowcÛw' FROM kierowca; 